...
% Plot E1 vs. Vf
subplot(2, 1, 2);
plot(Vf, E1, 'r-', 'LineWidth', 1.5);
grid on
xlabel('Fiber Volume Fraction (Vf)');
ylabel('Longitudinal Modulus (E1) [GPa]');
title('Longitudinal Modulus (E1) vs. Fiber Volume Fraction (Vf)');
...
% E2Calculate calculates the transverse modulus E2 using the selected
    ...
    % method: Method to calculate the transverse modulus E2
        ...
        % 'modified': Modified rule-of-mixtures formula with eta = 0.5
